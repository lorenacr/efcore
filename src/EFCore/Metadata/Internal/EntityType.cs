...
public class EntityType : TypeBase, IMutableEntityType, IConventionEntityType, IRuntimeEntityType
{
        ...
        ConfigurationSource configurationSource)
    {
        ...
        if (oldPrimaryKey != null)
        {
            ...
            ReorderKeyProperties(oldPrimaryKey.Properties);
        }
        ...
        if (properties?.Count > 0 && newKey != null)
        {
            ...
            ReorderKeyProperties(newKey.Properties);
    ...
    private void ReorderKeyProperties(IReadOnlyList<Property> properties)
    {
        foreach (var property in properties)
        {
