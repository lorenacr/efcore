...
namespace Microsoft.EntityFrameworkCore.Diagnostics
{
    ...
    public static class RelationalStrings
    {
        ...
        /// <summary>
        ///     The index {indexProperties} on the entity type '{entityType}' cannot be configured because it is defined on the complex property '{property}', which is not mapped to a JSON column. Indexes on complex properties are only supported when the complex property is mapped to JSON.
        /// </summary>
